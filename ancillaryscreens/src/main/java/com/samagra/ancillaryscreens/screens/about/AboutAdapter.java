...
public class AboutAdapter extends RecyclerView.Adapter<AboutAdapter.ViewHolder> {
    ...
    private final AboutAdapter.AboutItemClickListener listener;

    public AboutAdapter(int[][] items, Context context, AboutAdapter.AboutItemClickListener listener) {
    ...
    public AboutAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AboutAdapter.ViewHolder(itemLayoutView, listener);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View view, AboutAdapter.AboutItemClickListener listener) {
            super(view);
            this.listener = listener;
